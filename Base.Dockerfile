...
# docker build . -f Base.Dockerfile -t izzyacademy/kafka-base:2.8 -t izzyacademy/kafka-base:latest
# docker push izzyacademy/kafka-base:2.8
# docker push izzyacademy/kafka-base:latest

# docker run --name kafkabase -it izzyacademy/kafka-base:2.8