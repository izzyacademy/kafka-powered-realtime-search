...
# docker build . -f Zookeeper.Dockerfile -t izzyacademy/zookeeper:2.8 -t izzyacademy/zookeeper:latest
# docker push izzyacademy/zookeeper:latest
# docker push izzyacademy/zookeeper:2.8